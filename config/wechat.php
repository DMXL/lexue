...
return [
    ...
    */
     'oauth' => [
         ...
         'callback' => env('WECHAT_OAUTH_CALLBACK', null),
     ],
    ...
    */
    'payment' => [
        ...
        'cert_path'          => env('WECHAT_PAYMENT_CERT_PATH', config_path('certs/wechat/apiclient_cert.pem')), // XXX: 绝对路径！！！！
        'key_path'           => env('WECHAT_PAYMENT_KEY_PATH', config_path('certs/wechat/apiclient_key.pem')),      // XXX: 绝对路径！！！！
