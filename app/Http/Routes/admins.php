...
Route::resource('lectures', 'LectureController', ['parameters' => 'singular']);
Route::post('lectures/{lecture}/thumb', ['as' => 'lectures.thumb.upload', 'uses' => 'LectureController@uploadThumb']);
Route::put('lectures/{lecture}/enable', ['as' => 'lectures.enable', 'uses' => 'LectureController@enable']);
Route::put('lectures/{lecture}/disable', ['as' => 'lectures.disable', 'uses' => 'LectureController@disable']);
...
Route::get('teachers/{teacher}/lectures', ['as' => 'teachers.lectures', 'uses' => 'LectureController@showTeacher']);
