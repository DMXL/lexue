    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            <table class="table table-hover no-margins">
                ...
                <thead>
                    <tr>
                        <th colspan="7">{{ humanDate($date, true) }}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td><i class="fa fa-clock-o m-r-xs"></i>{{ humanTime($schedule->start).' - '.humanTime($schedule->end) }}</td>
                        <td><a href="{{ route('admins::teachers.show', $schedule->teacher->id) }}">{{ $schedule->teacher->name }}</a></td>
