...
@section('content')
    ...
    <form class="m-t" role="form" method="POST" action="{{ route('auth::register.post', userType()) }}">
        {{ csrf_field() }}
        ...
        <a class="btn btn-sm btn-white btn-block" href="{{ route('auth::login.get', userType()) }}">Login</a>
    </form>
@endsection